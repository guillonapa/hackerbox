...
export class Stories extends React.Component {
  ...
  constructor(props) {
    ...
    if(this.props.title === 'Saved Stories') {
      cards = (<div id={this.props.id} dataSpy="scroll" dataTarget="#list-example" dataOffset="0" className="scrollspy-example" style={{minHeight: '60vh', background: storiesColor}}></div>);
    } else {
      cards = (<div id={this.props.id} dataSpy="scroll" dataTarget="#list-example" dataOffset="0" className="scrollspy-example" style={{minHeight: '60vh', background: storiesColor}}>
